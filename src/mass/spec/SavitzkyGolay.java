...
public class SavitzkyGolay {
    ...
    int window;
        ...
        public SavitzkyGolay (double[][] vals, int wind, int deg) {
        ...
        public SavitzkyGolay (double[] xvals, double[] yvals, int wind, int deg) {
            if (window%2 != 1) window-=1;
            window = wind;
            degree = deg;
            data = new double[2][];
        ...
        public double getSmoothedPoint (int index) {
        ...
        private double[] fitPolynomial (double[][] data) {
